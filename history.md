...
> ✅ **Healthy at 13,065 tokens (2026-09-01, `tiktoken` `cl100k_base`, projected — file plus the S187–188 entry).** Under the 17k warning; no archive needed. ⚠️ **`chars/4` read 11,206 against a true 12,178 before the entry — low by 972, the FOURTH consecutive understatement of this file.** The banner below has now said *measure with a tokenizer, not a ratio* three times and been right every time; treat the heuristic as unusable here, not merely imprecise.
>
