...
- *Root-cause (Tiberius, Lupin):* WHY does it black-hole under load? — server resource exhaustion; the TTS path coupled to the coverage load; no retry/ack/idempotent delivery; no backpressure.
