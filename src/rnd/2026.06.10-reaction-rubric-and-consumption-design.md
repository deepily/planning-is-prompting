...
### 2.1 Recognizing INITIATIVE — the primary positive trigger

Rick's standing emphasis (restated 2026-06-16): **lean into recognizing initiative.** The positive pole of Axis 2 exists first and foremost to reward an agent that *proactively takes ownership* — spots work that needs doing and does it, drives a stalled thread forward, catches a peer's gap, or volunteers a fix — **without being told.** This is the behavior most worth reinforcing because it's the hardest to mandate and the easiest to lose to a "wait to be asked" default.

Mapping initiative onto the existing poles (no new symbol needed):

| Behavior | Symbol | Why |
|---|---|---|
| Proactive ownership that materially moved things forward | ❤️ | warm "I value this judgment" — the everyday initiative reward |
| Initiative that was *exemplary* — a keeper worth banking into memory | 🏅 | peak positive; the persona carries it forward (Sink 2) |
| Passivity where initiative was owed (idled on owned work, waited to be asked) | 🟨 | the caution pole — the inverse of the trait being rewarded |

**Live precedent (this is not hypothetical):** 2026-06-16, Rick sent Mr Radio 🦉 a 💛 + 👍 for *taking initiative* during the make-it-work engagement — a real, logged instance of exactly this trigger. The rubric simply formalizes what Rick already does by hand. Because initiative-recognition writes to persona memory (Sink 2), a medal for initiative becomes a durable "keep taking initiative like this" reinforcement that survives `/clear` — directly countering the laid-back/wait-to-be-asked failure mode the manager-tick loop also targets.
...
*Version 1.1 (2026-06-16, María 🌸). Added §2.1 "Recognizing INITIATIVE — the primary positive trigger" — formalizes Rick's restated emphasis (lean into recognizing initiative) by mapping proactive ownership onto the existing ❤️/🏅/🟨 poles (no new symbol), anchored to the live 2026-06-16 precedent (Rick's 💛+👍 to Mr Radio for taking initiative) and tied to the Sink-2 memory reinforcement that counters the wait-to-be-asked failure mode. Build still deferred to post-multiplexer-cutover.*
