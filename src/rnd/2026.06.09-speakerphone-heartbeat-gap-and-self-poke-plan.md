...
*Related: [[the joint post-game]] `io/post-games/2026.06.09-arbiter-operator-loop-2b-observer-postgame.md`; arbiter deploy design `src/rnd/2026.06.07-arbiter-deploy-architecture.md`; heartbeat hook authority `src/rnd/2026.06.02-stop-hook-natural-heartbeat-poker.md` §0.*
