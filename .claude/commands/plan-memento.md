...
**Canonical workflow**: `workflow/memento-management.md` — read for the 7-element memento contract, file location convention, lifecycle, and rehydration mechanism.
...
1. Read the canonical 7-element memento contract from `workflow/memento-management.md` §2
...
2. Validate the 7-element contract is satisfied; flag any missing elements
...
3. Report whether it satisfies the 7-element contract
...
1. **MUST read `workflow/memento-management.md`** before invoking — do not improvise the 7-element contract
...
- `workflow/memento-management.md` — canonical workflow + 7-element contract
