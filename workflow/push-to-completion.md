...
> **🛑 Companion command**: `/plan-kiss` fires the **brevity mandate** (KISS · Say 3LoL · NoMC C2C · NoAA · NoDrama · WaHH) at the fleet the same way this one fires the drive-to-completion order. Same broadcast shape, different defect: `/plan-push` fixes a manager who won't *move*; `/plan-kiss` fixes one who won't *stop talking*. Canonical: `workflow/brevity-mandate.md`.
>
